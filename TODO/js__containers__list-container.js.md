...
**Origin:** `js/containers/list-container.js` in `dbl-components`.
**Destination:** `js/containers/list-container.js` in `react-goat`.
**Existing TS:** Yes, already exists in `react-goat` at `containers/list-container.tsx`.
