...
**Origin:** `js/navigation/react-router-navlink.js` in `dbl-components`.
**Destination:** `js/navigation/react-router-navlink.js` in `react-goat`.
**Existing TS:** Yes, already exists in `react-goat` at `navigation/react-router-navlink.tsx`.
